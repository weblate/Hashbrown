...
<div class="c-dash">
	<a
		...
		alt="Home"
	>
		<img draggable="false" alt="Hashbrown icon" src="/logos/hashbrown.png" />
		<span class="c-tooltip">Hashbrown</span>
	</a>
	<a
		tabIndex={shouldTab}
		class="c-dash-item"
	...
	<a
		...
		sveltekit:prefetch
		href="/code"
		alt="Hashbrown's code using github1s.com"
	>
